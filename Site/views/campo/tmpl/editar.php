	...
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				...
				<input class="text_area" type="radio" name="es_obligatorio" id="es_obligatorio0" <?php echo ($this->formulario->usar_notificacion==true)?"checked":""; ?>  value="1" /> SI
				<input class="text_area" type="radio" name="es_obligatorio" id="es_obligatorio1" <?php echo (!$this->formulario->usar_notificacion==true)?"checked":""; ?> value="0"/> NO
			</td>
			</tr>
