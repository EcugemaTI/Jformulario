...
class SyscardViewActivacion extends JView
{
    ...
    function display($tpl = null)
    {
		...
		$this->logging(1,'ActivacionView.display', 'EstadoCivil:' . print_r($estadoCivil,true));

		$nacionalidad = $model->getNacionalidad();
		$this->assignRef('nacionalidad',$nacionalidad);
		$situacion = $model->getSituacion();
		$this->assignRef('situacion',$situacion);*/

		$nombres = JRequest::getCmd('nombres');
		$apellidos = JRequest::getCmd('apellidos');
		$identificacion = JRequest::getCmd('identificacion');
		$cupo = JRequest::getCmd('cupo');
		$mensaje = str_replace('_',' ',JRequest::getCmd('mensaje'));
		$mensaje = str_replace('bOOr','<br>',$mensaje);
		$status = JRequest::getCmd('status');
		$this->assignRef('mensaje',$mensaje);
		$this->assignRef('status',$status);
		$this->assignRef('nombres',$nombres);
		$this->assignRef('apellidos',$apellidos);
		$this->assignRef('identificacion',$identificacion);
		$this->assignRef('cupo',$cupo);
