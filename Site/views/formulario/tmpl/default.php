	...
	<fieldset class="adminform">
		...
		<tr>
			...
			<td>
				...
				<input class="text_area" type="radio" name="usar_notificacion" id="usar_notificacion0" <?php echo ($this->formulario->usar_notificacion==true)?"checked":""; ?>  value="1" /> SI
				<input class="text_area" type="radio" name="usar_notificacion" id="usar_notificacion1" <?php echo (!$this->formulario->usar_notificacion==true)?"checked":""; ?> value="0"/> NO
			</td>
			</tr>
			<tr>
			<td width="100" align="right" class="key">
			...
			<td>
				<input class="text_area" type="radio" name="usar_envio" id="usar_envio0" <?php echo ($this->formulario->usar_envio==true)?"checked":""; ?>  value="1" /> SI
				<input class="text_area" type="radio" name="usar_envio" id="usar_envio1" <?php echo (!$this->formulario->usar_envio==true)?"checked":""; ?> value="0" /> NO
			</td>
			</tr>
			<tr>
			<td width="100" align="right" class="key">
